...
namespace MoviesAPI.Controllers
{
    ...
    public class MoviesController : ControllerBase
    {
        ...
        public MoviesController(ApplicationContext context, IMapper mapper, IFileStorageService fileStorageService, UserManager<IdentityUser> userManager)
        {
        ...
        public async Task<ActionResult<MoviePutGetDTO>> PutGet()
        {
            int id = 1;
            ...
            var generesSelectedIds = movie.Genres.Select(x => x.Id).ToList();
            var nonSelectedGenres = await context.Genres.Where(x => !generesSelectedIds.Contains(x.Id)).ToListAsync();
